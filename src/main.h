...
static const int CUTOFF_POW_BLOCK = 100;
...
static const unsigned int FORK_TIME = 1528894800; // Wednesday, June 13, 2018 1:00:00 PM GMT
...
static const uint256 hashGenesisBlockOfficial("0x7f06270eada62ade81aa19b05a73b8cb2d9ad9ea7720a5277bb1de8b38a32dee");
static const uint256 hashGenesisBlockTestNet ("0x7f06270eada62ade81aa19b05a73b8cb2d9ad9ea7720a5277bb1de8b38a32dee");
...
public:
    ...
    {
        // rapidstake: the coin stake transaction is marked with the first output empty
    ...
    */
    ...
    bool GetCoinAge(CTxDB& txdb, uint64& nCoinAge) const;  // rapidstake: get transaction coin age
...
public:
    ...
    // rapidstake: block signature - signed by one of the coin base txout[N]'s owner
    ...
    // rapidstake: entropy bit for stake modifier if chosen by modifier
    ...
    // rapidstake: two types of block: proof-of-work or proof-of-stake
    ...
    // rapidstake: get max transaction timestamp
